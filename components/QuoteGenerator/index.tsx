...
const QuoteGeneratorModal = ({
  ...
  const wiseDevQuote = `"If you didn't succeed on the first try, just call it version 1.0."`;
  const wiseDevQuoteAuthor = `- A job-seeking software engineer` ;
  const [blobUrl, setBlobUrl] = useState<string | null>(null);

  //Function for handleing the download of quote card
  ...
  //Function for handle the receiving of quote card
  useEffect(() => {
    if (quoteReceived) {
